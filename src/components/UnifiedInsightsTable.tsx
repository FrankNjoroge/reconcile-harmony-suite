  ...
  const tabConfig = [
    {
      ...
      bgColor: 'bg-green-50/80 border-green-200 dark:bg-green-950/30 dark:border-green-800/50',
      activeBg: 'data-[state=active]:bg-green-100 dark:data-[state=active]:bg-green-900/40',
    ...
    },
    {
      ...
      bgColor: 'bg-amber-50/80 border-amber-200 dark:bg-amber-950/30 dark:border-amber-800/50',
      activeBg: 'data-[state=active]:bg-amber-100 dark:data-[state=active]:bg-amber-900/40',
    ...
    },
    {
      ...
      bgColor: 'bg-red-50/80 border-red-200 dark:bg-red-950/30 dark:border-red-800/50',
      activeBg: 'data-[state=active]:bg-red-100 dark:data-[state=active]:bg-red-900/40',
    ...
    },
    {
      ...
      bgColor: 'bg-orange-50/80 border-orange-200 dark:bg-orange-950/30 dark:border-orange-800/50',
      activeBg: 'data-[state=active]:bg-orange-100 dark:data-[state=active]:bg-orange-900/40',
